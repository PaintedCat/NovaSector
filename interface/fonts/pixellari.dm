...
/datum/font/pixellari
	name = "Pixellari"
	font_family = 'interface/fonts/Pixellari_modif.ttf' ///CHANGE SpaceCub: using Cyrillic fonts interface/fonts/Pixellari.ttf>interface/fonts/Pixellari_modif.ttf
