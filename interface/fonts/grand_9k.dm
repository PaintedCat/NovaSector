...
/datum/font/grand9k
	name = "Grand9K Pixel"
	font_family = 'interface/fonts/Grand9K_Pixel_modif.ttf'///CHANGE SpaceCub: using Cyrillic fonts interface/fonts/Grand9K_Pixel.ttf > interface/fonts/Grand9K_Pixel_modif.ttf
