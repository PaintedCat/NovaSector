...
/datum/font/tiny_unicode
	name = "TinyUnicode"
	font_family = 'interface/fonts/TinyUnicodeRus.ttf' ///CHANGE SpaceCub: using Cyrillic fonts interface/fonts/TinyUnicode.ttf>interface/fonts/TinyUnicodeRus.ttf
